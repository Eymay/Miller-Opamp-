...
C {devices/isource.sym} 160 -140 0 0 {name=I0 value=100u}
...
C {devices/lab_pin.sym} 160 -200 1 0 {name=l10 sig_type=std_logic lab=IBIAS}
C {devices/spice_probe.sym} 760 -200 0 0 {name=p1 attrs=""
voltage=0.9004}
C {devices/lab_pin.sym} 490 -110 1 0 {name=l11 sig_type=std_logic lab=Vin}
C {devices/vsource.sym} 440 -160 2 0 {name=V3 value="PULSE(0.2 0.8 1ns 100ps 100ps 120ns 240ns )"}
C {devices/res.sym} 550 -130 0 0 {name=R2
value=1k
footprint=1206
device=resistor
m=1}
