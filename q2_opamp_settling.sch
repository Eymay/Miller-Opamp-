...
descr="Vds="}
C {devices/lab_wire.sym} 960 -280 0 0 {name=l24 sig_type=std_logic lab=Vx
}
...
C {devices/vsource.sym} -350 -120 2 0 {name=V3 value="PULSE(0.2 0.8 1ns 100ps 100ps 120ns 240ns )"}
